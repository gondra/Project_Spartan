...
public class FetchJSONForActivity extends AsyncTask<String, String, String> {
    Context mContext;
    ProgressBar bar;
    Activity fragment;
    String errorMsg;

    public FetchJSONForActivity(Activity fragment, Context mContext, ProgressBar bar) {
        super();
